...
V_dot_hpp = n_series * n_parallel * J_w*A_mem*(1e-3)/3600;    %High pressure pump flow rate [m^3/s] %change eqn to calc J_w    %Do we not want to add a multiply by n_para in front?
