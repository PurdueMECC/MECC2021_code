...
eta_hp = 1%0.85;                     %mechanical efficiency of HPP1
...
n_par = 5;                        %Number of membranes in parallel
...
L_mem = .96;                      %Length of membrane [m]
% A_mem = 40.88;                         %Area of membrane [m^2]
A_mem = 7.4*4;                        %Area of membrane [m^2]
...
eta_motor = 1%.95;  % Motor efficiency (from PTO-Sim paper https://energy.sandia.gov/wp-content/uploads/2014/06/SAND2015-2069C.pdf)
% ditto in https://www.nrel.gov/docs/fy19osti/71078.pdf

p_c_init = p_rated - 0.5e6;  % Pa, based on viewed results
p_h_init = p_rated;
